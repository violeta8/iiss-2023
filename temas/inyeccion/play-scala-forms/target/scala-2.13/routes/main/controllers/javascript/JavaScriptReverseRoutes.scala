...
package controllers.javascript {
  ...
  class ReverseStudentController(_prefix: => String) {
    ...
    def index: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.StudentController.index",
      """
        function() {
    ...
    // @LINE:9
    def listStudent: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.StudentController.listStudent",
      """
        function() {
    ...
    def createStudent: JavaScriptReverseRoute = JavaScriptReverseRoute(
      ...
      """
        function() {
          return _wA({method:"POST", url:"""" + _prefix + { _defaultPrefix } + """" + "Students"})
        }
      """
    )
